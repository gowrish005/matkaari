    ...
    <section id="contact" className="py-20 md:py-32 overflow-hidden" style={{ backgroundColor: '#FFFFFF' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <h3 className="text-2xl font-heading font-bold mb-6" style={{ color: '#B7410E' }}>
              Send Us a Message
            </h3>
            
            {submitted && (
              <div className="px-4 py-3 rounded-xl mb-6 animate-pulse" style={{ backgroundColor: '#E4A93E', color: '#FFFFFF', border: '2px solid #B7410E' }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full group relative px-8 py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center justify-center space-x-2"
